...
var IPython = (function (IPython) {
     ...
     */
    var LPQueryCell = function (kernel, lpprogram) {
     ...
     * @method execute
     */
    LPQueryCell.prototype.execute = function () {
        ...
        var msg_id = this.kernel.execute(this.get_text(), callbacks,
                                         {input: "query",
                                          module: this.lpprogram.get_module_name(),
                                          silent: false});
    };


    LPQueryCell.prototype.fromJSON = function (data) {
        IPython.Cell.prototype.fromJSON.apply(this, arguments);
        if (data.cell_type === 'lpquery') {
    ...
    LPQueryCell.prototype.toJSON = function () {
        var data = IPython.Cell.prototype.toJSON.apply(this);
        data.input = this.get_text();
        data.cell_type = 'lpquery';
    ...
    IPython.LPQueryCell = LPQueryCell;
